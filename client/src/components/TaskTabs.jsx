				...
				return (
					<button
						...
						className={[
							...
							"md:rounded-l-md md:rounded-r-none md:py-3 md:pl-4 md:pr-3",
							isActive
								? "bg-accent/15 text-accent md:z-10 md:-mr-px md:bg-panel-alt md:shadow-tab"
								: "text-muted hover:bg-panel-alt/60 hover:text-ink md:mr-2 md:hover:translate-x-1 md:hover:bg-transparent",
						].join(" ")}>
						{isActive && (
